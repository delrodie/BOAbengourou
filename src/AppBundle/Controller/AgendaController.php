...
class AgendaController extends Controller
{
     ...
     *
     * @Route("/new", name="admin_agenda_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_agenda_show', array('slug' => $agenda->getSlug()));
        }
     ...
     *
     * @Route("/{slug}", name="admin_agenda_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="admin_agenda_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="admin_agenda_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Agenda $agenda)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_agenda_delete', array('id' => $agenda->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
