...
class Annuaire
{
     ...
     * @var string
     *
     * @ORM\Column(name="linked", type="string", length=255, nullable=true)
     */
    private $linked;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Domaine", inversedBy="annuaires")
     ...
     *
     * @Vich\UploadableField(mapping="annuaire_image", fileNameProperty="imageName", size="imageSize")
     *
     * @var File
     */
    private $imageFile;
